...
The underlying code (in the "lib" folder, not this example) now also supports WIZnet Pico boards with the WIZnet libraries, add "add_definitions(-DWIZNET_BOARD)" to your project to enable.
